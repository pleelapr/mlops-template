...
git_folder_location='/Users/plee/Documents/GitHub'   #replace with the local root folder location where you want to create the project folder
project_name=mlops-azureml-poc   #replace with your project name
github_org_name=pleelapr   #replace with your github org name
